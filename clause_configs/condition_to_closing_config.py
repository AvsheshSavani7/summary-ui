CONDITION_TO_CLOSING_CLAUSES = {
    ...
    "Conditions to Closing : Highlight Conditions": {
        ...
        "conditions": [
            ...
            "true": {
                "add_to_prompt": {
                        ...
                        "parent_shareholder_threshold": "{{conditions_to_closing.parent_shareholder_approval_threshold.clause_text}}"
                    },
            },
            "false": {
                "add_to_prompt": {
                        "parent_shareholder_vote": "",
                        "parent_shareholder_threshold": ""
                },
            }
            },
            {
        ...
        "prompt_template": (
            ...
            "Task:\n"
            "- Review the provided fields and construct a single clear easy to read sentence summarizing the material conditions.\n"
            "- The sentence must begin with: 'Subject to...'\n"
            "- Include only the following elements **once** and in this order if available:\n"
            "  • Target shareholder approval (use threshold from {target_shareholder_threshold})\n"
            "  • Parent shareholder approval (use threshold from {parent_shareholder_threshold})\n"
            ...
            "-- Provided Fields:\n"
            "- Target Shareholder Threshold: {target_shareholder_threshold}\n"
            "- Parent Shareholder Threshold: {parent_shareholder_threshold}\n"
            "- HSR Clearance: {hsr_clearance}\n"
            "- Other Customary Conditions: {other_conditions}\n\n"
            "--- Example Output:\n"
            "Subject to majority shareholder approval, HSR clearance, and other customary conditions.:\n"
