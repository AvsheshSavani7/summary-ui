CONSIDERATION_CLAUSES = {
    ...
    "Consideration Details - Concise": {
        ...
        "conditions": [
            ...
            {
                "question": "Consideration Details",
                "if": "complex_consideration_and_dividends.exchange_ratio.exchange_ratio_exists.answer",
                "type": "boolean",
                "true": {
                    "add_to_prompt": {
                        "exchange_details": "{{complex_consideration_and_dividends.exchange_ratio.exchange_ratio_summary.clause_text}}"
                    }
                },
                "false": {
                    "add_to_prompt": {
        ...
        "reference_fields": ["complex_consideration_and_dividends.deal_consideration.deal_consideration_details.reference_section"],
    ...
    "Target Dividends - Concise": {
        ...
        "prompt_template": (
            ...
            "Task:\n"
            "- Return a single, clear, concise sentence simply stating whether the target company is permitted to pay dividends prior to closing.\n"
    ...
    "Parent Dividends - Concise": {
        ...
        "prompt_template": (
            ...
            "Task:\n"
            "- Return a single, clear, concise sentence simply stating whether the parent company is permitted to pay dividends prior to closing.\n"
    ...
    "Proration - Concise": {
        ...
        "prompt_template": (
            ...
            "Task:\n"
            "- Determine if the proration clause explicity contains proration mechanics.\n"
            "- If an only if the clause explicitly details proration mechanics, create a summary of those mechanics\n"
            "- If the clause does not explicityly detail specific proration mechanics as they apply to the merger, return nothing, not an explanation explaining why it is not included. Return an empty string.\n"
            "-- You are reviewing the following clause:\n"
            ...
            "Format as a single sentence paragraph. Do not return anything unless proration terms are clearly described."
    ...
    "Consideration Details - Fulsome": {
        ...
        "format_style": "paragraph",
        "max_words": 50,
        "summary_display_section": "Consideration and Dividends",
        "summary_rank": 4.1,
        "view_prompt": True
    },

    "Contingent Payments - Fulsome": {
        "question": "Contingent Payments",
        "conditions": [
            {
                "question": "Contingent Payments",
                "if": "complex_consideration_and_dividends.contingent_payments.contingent_payments_exists.answer",
                "type": "boolean",
                "true": {
                    "add_to_prompt": {
                        "contingent_payment_details": "{{complex_consideration_and_dividends.contingent_payments.contingent_payments_details.answer}}",
                        "contingent_payment_text": "{{complex_consideration_and_dividends.contingent_payments.contingent_payments_details.clause_text}}"
                    }
                },
                "false": {
                    "text_output": ""
        ...
        "prompt_template": (
            "You are a legal analyst reviewing the merger consideration terms in a merger agreement.\n\n"
            "Task:\n"
            "- Return a single, consolidated sentence confirming that a contingent payment exists and include the details.\n"
            "- Use only the information that is clearly applicable and stated in the clause text.\n"
            "- If parties are not explicitly named in the clause, infer them using surrounding context or typical roles (e.g., Parent = Acquirer, Company = Target).\n"
            "- Do not include extra legal context or phrases like 'from Parent' or 'without interest'.\n"
            "- Be concise but ensure clarity on who gives and who receives in share exchanges.\n\n"
            "-- You are reviewing the following three clauses:\n"
            "1. Contingent Payment Details: {contingent_payment_details}\n"
            "2. Contingent Payment Raw Text: {contingent_payment_text}\n"

        ),

        "output_field": "contingent_payment_summary",
        "reference_fields": ["complex_consideration_and_dividends.contingent_payments.contingent_payments_exists.reference_section"],
        "use_short_reference": True,
        "summary_type": "Fulsome",
        "format_style": "paragraph",
        "max_words": 50,
    ...
    "Parent Dividends - Fulsome": {
        ...
        "conditions": [
            {
                ...
                "false": {
                    "add_to_prompt": {
                        "parent_dividends": "{{complex_consideration_and_dividends.company_dividends.parent_dividends_can_pay.clause_text}}"
                }
                }
            }
        ],
        "prompt_template": (
            "You are a legal analyst reviewing a merger agreement for dividend-related provisions.\n\n"
            "Task:\n"
            "- Return a single, clear, concise sentence simply stating whether the Parent is permitted to pay dividends prior to closing.\n"
            # "- If dividends are permitted, include any relevant details such as limits, timing, or references to other documents (e.g., Company Disclosure Letter).\n"
            "- If dividends are not permitted, state that clearly.\n"
            "- Do not include any legal disclaimers, party names, or interpretation beyond the clause text.\n"
            "- Use concise legal summary language.\n\n"
            ...
            "1. Parent Dividends: {parent_dividends}\n\n"
            "--- Examples:\n"
            "The Parent is not permitted to pay dividends prior to closing.\n"
            "The Parent may continue to pay quarterly dividends as specified in the Company Disclosure Letter.\n"
            "Dividends are only allowed if declared in the ordinary course and consistent with past practice.\n\n"
            "Format the response in a paragraph style."
        ),
    ...
    "Dividend Adjustment Mechanism - Fulsome": {
        "question": "Dividend Adjustment Mechanism",
        "conditions": [
            {
                "question": "Dividend Adjustment Mechanism",
                "if": "complex_consideration_and_dividends.dividend_adjustment_mechanism.dividend_adjustment_mechanism_exists.answer",
                "type": "boolean",
                "true": {
                    "add_to_prompt": {
                        "dividend_answer": "{{complex_consideration_and_dividends.dividend_adjustment_mechanism.dividend_adjustment_mechanism.answer}}",
                        "dividend_text": "{{complex_consideration_and_dividends.dividend_adjustment_mechanism.dividend_adjustment_mechanism.clause_text}}"
                    }
                },
                "false": {
                    "false": {
        ...
        "prompt_template": (
            "You are a legal analyst reviewing a merger agreement for a dividend adjustment mechanism.\n\n"
            "Task:\n"
            "- Return a single, clear, concise sentence simply stating whether the deal has a dividend adjustment mechansm and if so what that is.\n"
            "- Do not include any legal disclaimers, full party names, or interpretation beyond the clause text.\n"
            "- Use concise legal summary language.\n\n"
            "-- You are reviewing the following clause:\n"
            "1. Dividend Adjustment Answer: {dividend_answer}\n"
            "2. Dividend Adjustment Text: {dividend_text}\n"
            "--- Examples:\n"
            "Parent may pay regular quarterly dividends not to exceed $0.41 per share.\n"
            "Parent is not permitted to declare or pay any dividends prior to closing.\n\n"
            "Format the response in a paragraph style."
        ...
        "output_field": "dividends_adjustment_mechanism",
        "reference_fields": ["omplex_consideration_and_dividends.dividend_adjustment_mechanism.dividend_adjustment_mechanism.reference_section"],
        "use_short_reference": True,
        "summary_type": "Fulsome",
        "format_style": "paragraph",
        "max_words": 30,
